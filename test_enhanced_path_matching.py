...
async def test_enhanced_path_matching():
    """测试优化后的文件路径匹配功能"""
    ...
    # Test cases - 实际变更的文件路径
    test_cases = [
        "nj/transformer-models/+gpt2/model.m",
        "nj/transformer-models/+bert/model.m",
        "nj/transformer-models/+finbert/model.m",
        "nj/transformer-models/+gpt2/+internal/getSupportFilePath.m",
        "some/other/path/model.m"
    ]
    
    print("=== 测试优化后的文件路径匹配功能 ===")
    print("=" * 60)
    ...
    test_file = "nj/transformer-models/+gpt2/model.m"
...
if __name__ == "__main__":
    asyncio.run(test_enhanced_path_matching()) 